...
**(8) THE WEEKLY-ESSENTIALS RATING.** Weekly, **each group leader rates every child** in their group on "the essentials" (respect, effort, … — exact set TBD from first principles; part of staff's job), and **each PARENT is likewise required to rate their own child weekly**; seamless, ~25 sec, each 1–10 as **STARS**. The essentials score **SHOWN on Follow Me = the AVERAGE of the group-leaders' weekly ratings**; grades etc. = downstream curation. Fits stars-not-grades / weight-faithfulness / first-name-only / invite-only.
